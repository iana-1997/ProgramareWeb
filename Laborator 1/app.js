...
function Adaugare(){
    ...
    nr[1].push(2);
    nr[2].push(15);   
    console.log('Tabelul cu cifra adaugata 4, 2, 15: ');
    console.log(nr[0]);
    console.log(nr[1]);
    console.log(nr[2]);
}Adaugare()
...
/*function Inaltime() {
    var num = 0;
    var s = 0;
    for (var i = 0; i <= nr[2].length; i++){
            if (nr[2][i] > 3 && nr[2][i] < 9)
            {
                num +=1;
            }
            s = nr[2].length
...
}console.log('In total sunt --> ' + nr[2]+ ' sportivi cu inaltimea intre 3 si 30');